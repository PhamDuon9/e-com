...
export default async function Home(){
  ...
  return (
    <div className="py-6">
      ...
      <section className="max-w-screen-xl mx-auto px-4 mt-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          <div className="bg-white p-6 rounded-xl shadow h-full flex flex-col justify-between">
            <p className="text-gray-700 mb-4">"Shop tư vấn nhiệt tình, giao hàng nhanh, vợt chính hãng 100%"</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow h-full flex flex-col justify-between">
            <p className="text-gray-700 mb-4">"Sản phẩm chất lượng, giá hợp lý. Đóng gói cẩn thận."</p>
            <div className="mt-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gray-100"></div>
              <div>
          ...
          <div className="bg-white p-6 rounded-xl shadow h-full flex flex-col justify-between">
            <p className="text-gray-700 mb-4">"Mua giày ở đây rất ưng, đi êm và bám sàn tốt."</p>
            <div className="mt-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gray-100"></div>
              <div>
